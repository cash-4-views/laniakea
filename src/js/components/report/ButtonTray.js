	...
	render: function() {
		...
		return (
			<div className="btn-group btn-group-justified tableSelector" role="group" aria-label="...">
				  <Button type={"success " + activePanelClass("approved")} 	size="chief" 	 value="approved"   content="Approved"   onClickCallback={this.props.switchReportPanel} isLoading={this.props.loadingPanel==="approved"}/>
				  ...
				  <Button type={"info " + activePanelClass("unapproved")} 		size="chief" 	 value="unapproved" content="Unapproved" onClickCallback={this.props.switchReportPanel} isLoading={this.props.loadingPanel==="unapproved"}/>
				  ...
				  <Button type={"warning " + activePanelClass("unassigned")} size="chief" 	 value="unassigned" content="Unassigned" onClickCallback={this.props.switchReportPanel} isLoading={this.props.loadingPanel==="unassigned"}/>
