...
test("The Account constructer ", function(t) {
	...
	t.equal(approvedlist.tableName, "ACCOUNTTESTING", "should return an object with the table name specified");
	t.equal(approvedlist.PartitionKey, "users", "should return an object with the partitionkey as our default value");
	t.end();
});
...
test("The getAccounts function", function(t) {
	...
	tableSvc.insertEntity(tableName, newAccount2, {echoContent: true}, function(err1, result1, response2) {
		t.notOk(error, "shouldn't throw an error writing account 1");
		...
		tableSvc.insertEntity(tableName, newAccount2, {echoContent: true}, function(err2, result2, response2) {
			t.notOk(error, "shouldn't throw an error writing account 2");
